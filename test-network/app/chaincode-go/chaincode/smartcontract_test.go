...
import (
	...
	"github.com/hyperledger/fabric-samples/test-network/app/chaincode-go/chaincode"
	"github.com/hyperledger/fabric-samples/test-network/app/chaincode-go/chaincode/mocks"
